...
const Menu = () => {
  return (
    <div className="w-full h-[100vh] flex items-center">
      <div className="h-[90vh] mx-10 w-[70px] bg-gradient-to-t from-[#00327D] to-[#00091B] rounded-xl flex flex-col items-center justify-between ">
        {/* logo and main menu*/}
        <div className="my-10">
          ...
          <div className="flex flex-col gap-8 mt-20">
            ...
            <div>
              ...
              >
                <path
                  d="M12 3C9.1084 3 6.75 5.3584 6.75 8.25C6.75 10.0342 7.6582 11.6133 9.02344 12.5625C5.94434 13.7637 3.75 16.7637 3.75 20.25H5.25C5.25 16.9512 7.64355 14.1943 10.7812 13.6172L11.25 15H12.75L13.2188 13.6172C16.3564 14.1943 18.75 16.9512 18.75 20.25H20.25C20.25 16.7637 18.0557 13.7637 14.9766 12.5625C16.3418 11.6133 17.25 10.0342 17.25 8.25C17.25 5.3584 14.8916 3 12 3ZM12 4.5C14.0801 4.5 15.75 6.16992 15.75 8.25C15.75 10.3301 14.0801 12 12 12C9.91992 12 8.25 10.3301 8.25 8.25C8.25 6.16992 9.91992 4.5 12 4.5ZM11.25 15.75L10.5 20.25H13.5L12.75 15.75H11.25Z"
                  fill="white"
                />
              </svg>
            </div>
